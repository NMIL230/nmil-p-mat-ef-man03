...
from nmil_dlvm.utils.data_distribution_utils import (OUTLIER_HELDOUT_SESSIONS, DATASET,SUMMARIZED_METRICS_MAIN_MOMENTS_LABEL_DICT, 
...
def main():
    ...
    # Define logging
    log_file = os.path.join(plots_dir, f'plot_fit_error_curves_all_models_{dataset_name}.log')
