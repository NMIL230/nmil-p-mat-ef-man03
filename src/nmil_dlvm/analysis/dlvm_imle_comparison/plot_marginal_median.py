...
from nmil_dlvm.analysis.dlvm_imle_comparison.plot_rmse_curves_all_models import compute_rmse_per_metric, compute_kld_per_metric
...
def main():
    ...
    log_file = os.fspath(LOGS_DIR / "plot_marginal_median.log")
