#!/usr/bin/env python3
"""
export_synthetic_observations_csv.py

This script generates a CSV-ready DataFrame from synthetic observations.
The DataFrame has the following structure:
user_session, task_label, data_type, metric, result, presentation_time

Usage:
    python export_synthetic_observations_csv.py --N 1 \
...
def build_synthetic_observations_dataframe(synthetic_data, logger):
    """
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Export synthetic observations to CSV")
    parser.add_argument(
    ...
    log_file = os.path.join(args.log_dir, f'export_synthetic_observations_N{args.N}.log')
    ...
    custom_df = build_synthetic_observations_dataframe(
