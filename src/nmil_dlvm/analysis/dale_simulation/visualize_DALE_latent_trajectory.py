...
LOG_FILE = SCRIPT_DIR / "logs" / "visualize_DALE_latent_trajectory.log"

# Add project root to path to import repository modules.
...
from nmil_dlvm.paths import ANALYSIS_ARTIFACTS_ROOT, SAVED_MODELS_ROOT, results_dale_runs_dir
...
def to_numpy_cpu(value):
    """Convert a tensor or array-like value to a host NumPy array."""
...
def main():
    ...
    parser.add_argument('--output-dir', type=str, default=str(ANALYSIS_ARTIFACTS_ROOT / "dale_simulation" / "trajectory_visualization"),
    ...
    parser.add_argument("--performance-tracking-basepath", type=str, default=str(results_dale_runs_dir()),
    ...
    if args.latent_dim ==2:
        ...
        args.ground_truth_data_path = str(
            ANALYSIS_ARTIFACTS_ROOT
            / "generate_synthetic_item_observations"
            / "synthetic_data"
            / "COLL10_SIM"
            / "D2_synthetic_ground_truth_parameters_mongoose-dive-7464"
            / "all_synthetic_data_N240.pt"
        )
        ...
        args.ground_truth_data_path = str(
            ...
            / "synthetic_data"
            / "COLL10_SIM"
            / "D3_synthetic_ground_truth_parameters_beaver-slide-5310"
            / "all_synthetic_data_N240.pt"
        )
    ...
    try:
        ...
        for session_id in session_ids:
            ...
            from sklearn.preprocessing import MinMaxScaler
            scaler = MinMaxScaler()
            loss_np = scaler.fit_transform(to_numpy_cpu(loss).reshape(-1, 1)).flatten()
            # set loss value above 0.1 to 0.1
            loss_np = np.where(loss_np > 0.1, 0.1, loss_np)
