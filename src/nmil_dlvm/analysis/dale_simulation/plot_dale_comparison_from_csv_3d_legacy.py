...
# -*- coding: utf-8 -*-
"""
LEGACY 3D appendix plotter: use `plot_dale_comparison_from_csv.py` instead for
the current shared CSV-based comparison workflow.

This file preserves the old 3D-specific appendix plotting behavior.
...
def build_method_properties(all_methods: List[str]) -> Dict[str, Dict[str, str]]:
    ...
    method_config = {
        ...
        "DLVM_DALE_PS0": {
            "color": "#1f77b4",  # Blue
            "marker": "^",
            "label": "DLVM-3 + DALE + PS=0 ± SD"
        },
        "DLVM_DALE_PS1": {
            # Not specified by user; keep existing style
            "color": "#4169E1",
            "marker": "^",
            "label": "DLVM-3 + DALE + PS=1 ± SD"
        },
        "DLVM_DALE_PS2": {
            # Not specified by user; keep existing style
            "color": "#a455f3",
            "marker": "v",
            "label": "DLVM-3 + DALE ± SD"
        },
        "DLVM_DALE_PS4": {
            "color": "#ff7f0e",  # Orange
            "marker": "D",
            "label": "DLVM-3 + DALE + PS=4 ± SD"
        },
    }
...
def main():
    ...
    parser.add_argument("--csv_file", type=Path,
                        default=REPO_ROOT / "artifacts/analysis/dale_simulation/plot_data/3d-final/dale_comparison_data.csv",
                        help="Path to CSV file with comparison data")
    parser.add_argument("--output_dir", type=Path,
                        default=REPO_ROOT / "artifacts/analysis/dale_simulation/plot/DALE_DLVM_3_Evolution_v03",
                        help="Directory to save plots")
    parser.add_argument("--output_filename", type=str, 
                        default="DALE_DLVM_3_Evolution_v03",
    ...
    parser.add_argument("--methods", type=str, nargs="*", 
                        ...
                        # default=["DLVM_RANDOM", "DLVM_DALE_PS0" , "DLVM_DALE_PS2", "DLVM_DALE_PS4"],
