#!/usr/bin/env python3
"""Synthetic-data DALE entrypoint.

This module delegates execution to the canonical DALE CLI in
`nmil_dlvm.cli.run_dale` and injects synthetic-data defaults only when the
caller has not already provided them explicitly.
"""
