...
def main():
    ...
    parser.add_argument("--csv_file", type=Path,
                        default=REPO_ROOT / "analysis/dale_syn_data/plot_data/3d-final/dale_comparison_data.csv",
                        help="Path to CSV file with comparison data")
    parser.add_argument("--output_dir", type=Path,
                        default=REPO_ROOT / "analysis/dale_syn_data/plot/DALE_DLVM_3_Evolution_v03",
