...
def main():  
    ...
    DEFAULT_RES = SCRIPT_ROOT / "result" / "1d-final-now"  
    ...
    SYN_DATA_1D_PATH = REPO_ROOT/ "analysis/dlvm_imle_comparison/synthetic_data/COLL10_SIM/D1_all_synthetic_data_N240.pt"
    ...
    MODEL_1D_WOLVERINE = str(REPO_ROOT / 'saved_models/COLL10_SIM/heldout_obsmulti/variationalNN_relevant_only_latentdim1_wolverine-zoom-7298.pt')
