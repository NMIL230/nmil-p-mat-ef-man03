...
SOURCE_PDF = (
    PARAMS_DIR
    / "plots/validation_simulated/main_figure/KLD_combined_COLL10_SIM_combined_stddev_normalized_log_scale.pdf"
)
GROUND_TRUTH_FILES = {
    "D1_synthetic_ground_truth_parameters_wolverine-zoom-7298.pt":
...
def generate(dry_run=False):
    ...
    with temporary_copied_files(GROUND_TRUTH_FILES, "fig04_ground_truth") as ground_truth_dir:
        run_python_script(
            "src/nmil_dlvm/analysis/dlvm_imle_comparison/plot_merged_curves.py",
            [
                "--ground_truth_dir", ground_truth_dir,
