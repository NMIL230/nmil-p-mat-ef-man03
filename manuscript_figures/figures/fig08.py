...
def generate(dry_run=False):
    ...
    output_root = generated_output_dir("fig08")
    run_python_script(
    ...
    if dry_run:
        return
    source_pdf = output_root / run_id / "DALE_max_100_points" / (run_id + "_RMSE_vs_LogProb_scatter.pdf")
