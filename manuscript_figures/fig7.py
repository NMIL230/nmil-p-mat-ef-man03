...
def generate(
    ...
    """Generate Figure 7 using the repository's latent trajectory visualizer."""
    ...
    stem = f"{dale_run_id}_3x3_RMSE_LogProb_colorbar_True_axis_labels_True"
    ...
    for suffix in (".pdf", ".png"):
        ...
        if not source.is_file():
            raise FileNotFoundError(
                f"Expected 3x3 plot {source} was not found."
            )
